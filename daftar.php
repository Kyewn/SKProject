    ...
    <div class="content">
        <div class="container1">
            ...
            <div class="container2">
                <div class="labels">
                    <label for="kodalat">Kod Alat</label>
                    <label for="nama">Nama Alat</label>
                    <label for="bilalat">Bilangan Alat</label>
                    <label>Status Alat</label>
                </div>
                <form>
                    <input type="text" id="kodalat" name="kodalat" placeholder="PMS"><br />
                    <input type="text" id="namaalat" name="namaalat"><br />
                    <input type="text" id="bilalat" name="bilalat"><br />
                    <input type="text" value="BAIK" disabled/>
                </form>
                <div class="buttons">
                <button>OK</button>
